...
void AWeapon::ThrowWeapon()
{
	...
	//Diraction in which we throw the Weapon
	FVector ImpulseDiraction = MeshRight.RotateAngleAxis(-20.f, MeshForward);

	float RandomRotation{ FMath::FRandRange(-30.f,30.f) };
	ImpulseDiraction = ImpulseDiraction.RotateAngleAxis(RandomRotation, FVector(0.f, 0.f, 1.f));
	ImpulseDiraction *= 200'00.f;
